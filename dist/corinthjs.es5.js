...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('node-fetch')) : typeof define === 'function' && define.amd ? define(['exports', 'node-fetch'], factory) : (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Corinth = {}, global.nodeFetch));
})(void 0, function (exports, nodeFetch) {
  'use strict';
      ...
      var _v = function v() {
        ...
        return w(this, void 0, void 0, function () {
          ...
          return x(this, function (t) {
            switch (t.label) {
              case 0:
                return t.trys.push([0, 9,, 10]), r = void 0, i = "undefined" != typeof window && "[object Window]" === {}.toString.call(window), r = i ? fetch : nodeFetch__default['default'], s = Object.keys(this._opts.query).length ? this._opts.url + "?" + (n = this._opts.query, Object.keys(n).map(function (t) {
                  return t + "=" + String(n[t]);
